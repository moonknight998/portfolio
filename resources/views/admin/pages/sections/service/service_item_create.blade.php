            ...
            <div class="col-lg-12">
                <div class="card-group d-block d-md-flex row">
                    <div class="card col-md-7 p-2 mb-4">
                        ...
                        <form method="POST" action="{{route('admin.service_item.store')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                <div class="example">
                                    ...
                                    <div class="tab-content rounded-bottom" id="content_tab">
                                      <div class="tab-pane p-3 active preview" role="tabpanel" >
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input class="form-control" id="icon" name="icon" type="text" onchange="changeClassWithExtraParam(event, 'preview_icon', 'icon-backend')">
                                            @if ($errors->has('icon'))
                                                <div class="row mb-0">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input class="form-control" id="button_text" required name="button_text" type="text" placeholder="{{__('admin/common.read_more')}}" value="{{__('admin/common.read_more')}}"
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input class="form-control form-control-color" id="main_color" name="main_color" type="color" value="#00eeff" onchange="changeColor(event, 'preview_icon'); changeColor(event, 'preview_button'); changeStyle(event, 'preview_border_bottom', 'borderBottomColor')">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input class="form-control form-control-color" id="extra_color" name="extra_color" type="color" value="#c8fbfe" onchange="changeBackground(event, 'preview_icon')">
                                                ...
                                                <div class="container aos-init aos-animate" data-aos="fade-up">
                                                    ...
                                                    <div class="row gy-4" style="justify-content: center">
                                                        ...
                                                        <div class="col-lg-4 col-md-6 aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
                                                            ...
                                                            class="service-box" style="border-bottom-style: solid;  border-bottom-width: 3px; border-bottom-color: #00eeff;"
                                                            >
                                                                <i id="preview_icon" class="bi bi-check-square icon-backend" style="color: #00eeff; background: #c8fbfe; padding: 20px 20px;"></i>
                                                                <h3 id="preview_title">Nesciunt Mete</h3>
                                                                <p id="preview_item_description">Provident nihil minus qui consequatur non omnis maiores. Eos accusantium minus dolores iure perferendis tempore et consequatur.</p>
                                                                <a id="preview_button" href="#" class="read-more" style="color: #00eeff;"><span id="preview_button_text">{{__('admin/common.read_more')}}</span><i class="bi bi-arrow-right"></i></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
