                    ...
                    <div class="card-group d-block d-md-flex row">
                        <div class="card col-md-7 p-2 mb-4">
                            <div class="card-header">
                                <h2>{{ __('admin/testimonial/testimonial.update_title') }}</h2>
                            </div>
                            <form method="POST"
                                action="{{ $testimonial_title == null ? route('admin.testimonial_title.store') : route('admin.testimonial_title.update', $testimonial_title->id) }}"
                                            ...
                                            <div class="tab-pane p-3 active preview" role="tabpanel">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <textarea class="form-control" rows="5" id="title" name="title" type="text"
                                                        ...
                                                        onkeypress="detectEnterline(event, 'title'); loadDocument(event, 'preview_title')">{{ $testimonial_title ? ($testimonial_title->title === '' ? old('title') : $testimonial_title->title) : '' }}</textarea>
                                                    @if ($errors->has('title'))
                                                        <div class="row mb-0">
                                                            <div class="invalid-feedback" style="display: inline;">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <select class="form-select" id="status" name="status">
                                                        <option
                                                            {{ $testimonial_title ? ($testimonial_title->status == 1 ? 'selected' : '') : 'selected' }}
                                                            value="1">{{ __('admin/common.display') }}</option>
                                                        <option
                                                            {{ $testimonial_title ? ($testimonial_title->status == 0 ? 'selected' : '') : '' }}
