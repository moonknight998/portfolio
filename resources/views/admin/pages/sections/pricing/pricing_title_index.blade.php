                    ...
                    <div class="card-group d-block d-md-flex row">
                        <div class="card col-md-7 p-2 mb-4">
                            <div class="card-header">
                                <h2>{{ __('admin/pricing/pricing.update_title') }}</h2>
                            </div>
                            <form method="POST"
                                action="{{ $pricing_title == null ? route('admin.pricing_title.store') : route('admin.pricing_title.update', $pricing_title->id) }}"
                                            ...
                                            <div class="tab-pane p-3 active preview" role="tabpanel">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <textarea class="form-control" rows="5" id="title" name="title" type="text"
                                                        ...
                                                        onkeypress="detectEnterline(event, 'title'); loadDocument(event, 'preview_title')">{{ $pricing_title ? ($pricing_title->title === '' ? old('title') : $pricing_title->title) : '' }}</textarea>
                                                    @if ($errors->has('title'))
                                                        <div class="row mb-0">
                                                            <div class="invalid-feedback" style="display: inline;">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <select class="form-select" id="status" name="status">
                                                        <option
                                                            {{ $pricing_title ? ($pricing_title->status == 1 ? 'selected' : '') : 'selected' }}
                                                            value="1">{{ __('admin/common.display') }}</option>
                                                        <option
                                                            {{ $pricing_title ? ($pricing_title->status == 0 ? 'selected' : '') : '' }}
                                                                        ...
                                                                        <div class="col-lg-3 col-md-6" data-aos="zoom-in"
                                                                            ...
                                                                            <div class="box">
                                                                                ...
                                                                                <h3
                                                                                    ...
                                                                                    {{ $pricing_item_local->pricing_name }}
                                                                                </h3>
                                                                                <div class="price">
                                                                                    <span
                                                                                    ...
                                                                                    <span> /
                                                                                        {{ __('admin/common.month') }}</span>
                                                                                </div>
                                                                                <img src="{{ isset($pricing_item_local->image) ? $pricing_item_local->image : asset('frontend/assets/img/pricing-free.png') }}"
                                                                                    class="img-fluid" alt="">
                                                                                <ul>
                                                                                    <p
                                                                    ...
                                                                    <div class="col-lg-3 col-md-6" data-aos="zoom-in"
                                                                        ...
                                                                        <div class="box">
                                                                            <h3 style="color: #07d5c0;">
                                                                                {{ __('admin/pricing/pricing.pricing_name') }}
                                                                            </h3>
                                                                            <div class="price">
                                                                                <span
                                                                                    style="font-size: 1.5rem; color:rgb(65, 65, 65); font-weight:bold;">0</span>
                                                                                <sup>USD</sup>
                                                                                <span> /
                                                                                    {{ __('admin/common.month') }}</span>
                                                                            </div>
                                                                            <img src="{{ asset('frontend/assets/img/pricing-free.png') }}"
                                                                                class="img-fluid" alt="">
                                                                            <ul>
                                                                                <li>{{ __('admin/pricing/pricing.benefit') }}
                                                                                    1</li>
                                                                                <li>{{ __('admin/pricing/pricing.benefit') }}
                                                                                    2</li>
                                                                                <li>{{ __('admin/pricing/pricing.benefit') }}
