                ...
                <div class="col-lg-12">
                    <div class="card-group d-block d-md-flex row">
                        <div class="card col-md-7 p-2 mb-4">
                            ...
                            <form method="POST" action="{{ route('admin.client_item.update', $client_item->id) }}"
                                        ...
                                        <div class="tab-content rounded-bottom" id="content_tab">
                                            <div class="tab-pane p-3 active preview" role="tabpanel">
                                                ...
                                                <div class="form-group mb-3">
                                                    <label
                                                        class="form-label">{{ __('admin/client/client.brand_name') }}</label>
                                                    <input class="form-control" id="brand_name" name="brand_name"
                                                        type="text"
                                                        placeholder="{{ __('admin/client/client.brand_name_placeholder') }}"
                                                        onchange="loadDocument(event, 'preview_brand_name')"
                                                        value="{{ ShowFormValue($client_item, 'brand_name') }}"></input>
                                                    @if ($errors->has('brand_name'))
                                                        <div class="row mb-0">
                                                            <div class="invalid-feedback" style="display: inline;">
                                                                {{ $errors->first('brand_name') }}</div>
                                                        </div>
                                                    @endif
                                                </div>
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input class="form-control" id="logo" name="logo" type="file"
                                                        onchange="loadFile(event, 'preview_logo')">
                                                    @if ($errors->has('logo'))
                                                        <div class="row mb-0">
                                                            <div class="invalid-feedback" style="display: inline;">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <select class="form-select" id="status" name="status">
                                                        <option {{ $client_item->status == 1 ? 'selected' : '' }}
                                                            value="1">{{ __('admin/common.display') }}</option>
                                                        <option {{ $client_item->status == 0 ? 'selected' : '' }}
                                                ...
                                                <section id="clients" class="clients">
                                                    <div class="container" data-aos="fade-up">
                                                        <header class="section-header">
                                                            <h2>{{ ShowTextData($client_title, 'section_name', __('admin/common.section_name_preview')) }}
                                                            </h2>
                                                            <p>{{ ShowTextData($client_title, 'title', __('admin/common.title_preview')) }}
                                                            </p>
                                                        </header>
