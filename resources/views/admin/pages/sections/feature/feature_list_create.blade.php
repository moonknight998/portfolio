            ...
            <div class="col-lg-12">
                <div class="card-group d-block d-md-flex row">
                    <div class="card col-md-7 p-2 mb-4">
                        <div class="card-header"><h2>{{__('admin/feature/feature.create_feature_card')}}</h2></div>
                        <form method="POST" action="{{route('admin.feature_list.store')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                <div class="example">
                                    ...
                                    <div class="tab-content rounded-bottom" id="content_tab">
                                      <div class="tab-pane p-3 active preview" role="tabpanel" >
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input class="form-control" readonly id="icon" name="icon" type="text" onchange="changeAttribute(event, 'preview_icon', 'class')" value="bi bi-check">
                                            @if ($errors->has('icon'))
                                                <div class="row mb-0">
                                                                ...
                                                                <div class="row-md-6 align-self-center gy-4" style="width: 100%">
                                                                    ...
                                                                    <div class="col-md-6 aos-init aos-animate py-1" data-aos="zoom-out" data-aos-delay="200" style="width: 100%">
                                                                        <div class="feature-box d-flex align-items-center" style="width: 100%">
                                                                            ...
                                                                            <h3 id="preview_title">{{__('admin/feature/feature.title_placeholder')}}</h3>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
