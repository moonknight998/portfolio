                    ...
                    <div class="card-group d-block d-md-flex row">
                        <div class="card col-md-7 p-2 mb-4">
                            <div class="card-header">
                                <h2>{{ __('admin/feature/feature.update_feature_tab_title') }}</h2>
                            </div>
                            <form method="POST"
                                action="{{ $feature_tab_title == null ? route('admin.feature_tab_title.store') : route('admin.feature_tab_title.update', $feature_tab_title->id) }}"
                                            ...
                                            <div class="tab-pane p-3 active preview" role="tabpanel">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <textarea class="form-control" rows="1" id="title" name="title" type="text"
                                                        ...
                                                        onkeypress="detectEnterline(event, 'title'); loadDocument(event, 'preview_title')">{{ $feature_tab_title ? ($feature_tab_title->title === '' ? old('title') : $feature_tab_title->title) : '' }}</textarea>
                                                    @if ($errors->has('title'))
                                                        <div class="row mb-0">
                                                ...
                                                <div class="form-group mb-3">
                                                    <label
                                                        class="form-label">{{ __('admin/feature/feature.tab_quantity') }}</label>
                                                    <input class="form-control" id="tab_quantity" name="tab_quantity"
                                                        type="number" readonly value="3"
                                                        style="background-color: rgba(187, 187, 187, 0.4)">
                                                    @if ($errors->has('tab_quantity'))
                                                        <div class="row mb-0">
                                                            <div class="invalid-feedback" style="display: inline;">
                                                                {{ $errors->first('tab_quantity') }}</div>
                                                        </div>
                                                    @endif
                                                </div>
                                                <div class="form-group mb-3">
                                                    ...
                                                    <select class="form-select" id="status" name="status">
                                                        <option
                                                            {{ $feature_tab_title ? ($feature_tab_title->status == 1 ? 'selected' : '') : 'selected' }}
                                                            value="1">{{ __('admin/common.display') }}</option>
                                                        <option
                                                            {{ $feature_tab_title ? ($feature_tab_title->status == 0 ? 'selected' : '') : '' }}
                                                            ...
                                                            <div class="col-lg-6">
                                                                ...
                                                                <ul class="nav mb-3">
                                                                    <li><a class="nav-link active" data-bs-toggle="pill"
                                                                            href="#tab1">Preview tab 1</a></li>
                                                                    <li><a class="nav-link" data-bs-toggle="pill"
                                                                            href="#tab2">Preview tab 2</a></li>
                                                                    <li><a class="nav-link" data-bs-toggle="pill"
                                                                            href="#tab3">Preview tab 3</a></li>
                                                                </ul>
