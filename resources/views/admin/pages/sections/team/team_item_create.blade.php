            ...
            <div class="col-lg-12">
                <div class="card-group d-block d-md-flex row">
                    <div class="card col-md-7 p-2 mb-4">
                        ...
                        <form method="POST" action="{{route('admin.team_item.store')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                <div class="example">
                                    ...
                                    <div class="tab-content rounded-bottom" id="content_tab">
                                      <div class="tab-pane p-3 active preview" role="tabpanel" >
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            onkeypress="detectEnterline(event, 'description'); loadDocument(event, 'preview_description')" placeholder="{{__('admin/team/team.description_placeholder')}}"></textarea>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            onchange="loadDocument(event, 'preview_facebook_url')" value="{{__('admin/team/team.facebook_url_placeholder')}}"></input>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            onchange="loadDocument(event, 'preview_instagram_url')" value="{{__('admin/team/team.instagram_url_placeholder')}}"></input>
                                            @if ($errors->has('name'))
                                                <div class="row mb-0">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            onchange="loadDocument(event, 'preview_telegram_url')" value="{{__('admin/team/team.telegram_url_placeholder')}}"></input>
                                            @if ($errors->has('name'))
                                                <div class="row mb-0">
                                                            ...
                                                            <div class="member">
                                                                <div class="member-img">
                                                                    ...
                                                                    <div class="social">
                                                                        ...
                                                                        {{-- <a href=""><i class="bi bi-twitter"></i></a> --}}
                                                                        <a id="preview_instagram_url" href=""><i class="bi bi-instagram"></i></a>
                                                                        <a id="preview_telegram_url" href=""><i class="bi bi-telegram"></i></a>
                                                                        {{-- <a href=""><i class="bi bi-linkedin"></i></a> --}}
                                                                    </div>
                                                                </div>
                                                                <div class="member-info">
                                                                    <h4 id="preview_name">{{__('admin/common.name_preview')}}</h4>
                                                                    <span id="preview_work_title">{{__('admin/team/team.work_title_preview')}}</span>
                                                                    <p id="preview_description">{{__('admin/common.description_preview')}}</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
