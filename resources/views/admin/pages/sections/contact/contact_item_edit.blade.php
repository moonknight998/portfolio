                                            ...
                                            <div class="tab-pane p-3 active preview" role="tabpanel">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input class="form-control" id="title" name="title" type="text"
                                                        ...
                                                        value="{{ ShowFormValue($contact_item, 'title') }}">
                                                    @if ($errors->has('title'))
                                                        <div class="row mb-0">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input class="form-control" id="icon" name="icon" type="text"
                                                        ...
                                                        value="{{ ShowFormValue($contact_item, 'icon') }}" required>
                                                    @if ($errors->has('icon'))
                                                        <div class="row mb-0">
                                                            <div class="invalid-feedback" style="display: inline;">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <select class="form-select" id="status" name="status" required>
                                                        <option {{ $contact_item->status == 1 ? 'selected' : '' }}
                                                            value="1">{{ __('admin/common.display') }}</option>
                                                        <option {{ $contact_item->status == 0 ? 'selected' : '' }}
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="row gy-4">
                                                                    @foreach ($contact_items as $contact_item_local)
                                                                        <div class="col-md-6">
                                                                            <div class="info-box">
                                                                                <i id="{{ $contact_item_local->id == $contact_item->id ? 'preview_icon' : '' }}"
                                                                                    class="{{ $contact_item_local->icon }}"></i>
                                                                                <h3
                                                                                    id="{{ $contact_item_local->id == $contact_item->id ? 'preview_title' : '' }}">
                                                                                    {{ $contact_item_local->title }}</h3>
                                                                                <p
                                                                                    id="{{ $contact_item_local->id == $contact_item->id ? 'preview_first_line' : '' }}">
                                                                                    {{ $contact_item_local->first_line }}
                                                                                </p>
                                                                                <p
                                                                                    id="{{ $contact_item_local->id == $contact_item->id ? 'preview_second_line' : '' }}">
                                                                                    {{ $contact_item_local->second_line }}
                                                                                </p>
                                                                            </div>
                                                                        </div>
                                                                    @endforeach
