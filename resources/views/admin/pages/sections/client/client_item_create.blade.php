                ...
                <div class="col-lg-12">
                    <div class="card-group d-block d-md-flex row">
                        <div class="card col-md-7 p-2 mb-4">
                            ...
                            <form method="POST" action="{{ route('admin.client_item.store') }}"
                                                ...
                                                <section id="clients" class="clients">
                                                    <div class="container" data-aos="fade-up">
                                                        ...
                                                        <div class="clients-slider swiper">
                                                            <div
                                                                class="{{ count($client_items) > (MobileDetect()->isMobile() ? 0 : 4) ? 'swiper-wrapper align-items-center' : 'container-fluid little-item' }}">
                                                                @if (count($client_items) > 0)
                                                                    @foreach ($client_items as $client_item_local)
                                                                        <div
                                                                            class="{{ count($client_items) > (MobileDetect()->isMobile() ? 0 : 4) ? 'swiper-slide' : 'image-container' }}">
                                                                ...
                                                                <div
                                                                    class="{{ count($client_items) > (MobileDetect()->isMobile() ? 0 : 4) ? 'swiper-slide' : 'image-container' }}">
                                                                    <img id="preview_logo"
                                                                        src="{{ asset('frontend/assets/img/clients/preview-text-logo.png') }}"
