                                            ...
                                            @foreach ($blog_posts as $blog_post)
                                                <tr class="align-middle">
                                                    ...
                                                    <td style="width: 150px">
                                                        <div class="container"
                                                            style="display: flex; justify-content: center; width: 80px">
                                                            <img class="img-thumbnail" src="{{ $blog_post->thumbnail }}"
                                                    ...
                                                    <td style="width: 100px">
                                                        <div class="form-check form-switch"
                                                            ...
                                                            <input class="form-check-input change-status"
                                                                {{ $blog_post->status == 1 ? 'checked' : '' }}
                                                                data-id="{{ $blog_post->id }}" type="checkbox"
                                                                role="switch" id="flexSwitchCheckChecked">
                                                        </div>
                                                    </td>
                                                    <td style="width: 200px">
                                                        <div style="display: flex; justify-content: center; gap: 5px">
                                                            <a href="{{ route('blog.blog_post.edit', $blog_post->id) }}"
                                                                class="btn btn-success">{{ __('admin/common.edit') }} <i
                                                                    class="fas fa-pen"></i></a>
                                                            <a href="{{ route('blog.blog_post.destroy', $blog_post->id) }}"
                                                                class="btn btn-danger">{{ __('admin/common.delete') }} <i
