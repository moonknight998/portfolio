        ...
        <div class="container-fluid px-4">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb my-0">
                    ...
                    <li class="breadcrumb-item active"><a>{{ __('admin/testimonial/testimonial.create_item') }}</a></li>
                </ol>
            </nav>
        </div>
    </header>
                    ...
                    <div class="card-group d-block d-md-flex row">
                        <div class="card col-md-7 p-2 mb-4">
                            <div class="card-header">
                                <h2>{{ __('admin/testimonial/testimonial.create_item') }}</h2>
                            </div>
                            <form method="POST" action="{{ route('admin.testimonial_item.store') }}"
                                            ...
                                            <div class="tab-pane p-3 active preview" role="tabpanel">
                                                @if (session('status') === 'created')
                                                    <div class="alert alert-success alert-dismissible fade show"
                                                        role="alert">
                                                        {{ __('admin/testimonial/testimonial.item_created') }}
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input class="form-control" id="career" name="career" type="text"
                                                        ...
                                                        onchange="loadDocument(event, 'preview_career')"></input>
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <select class="form-select" id="rated" name="rated">
                                                        ...
                                                        <option selected value="5">5 {{ __('admin/common.star') }}
                                                        </option>
                                                    </select>
                                                </div>
                                                <div class="form-group mb-3">
                                                    ...
                                                    <textarea class="form-control" rows="5" id="feedback" name="feedback" type="text"
                                                        ...
                                                        placeholder="{{ __('admin/testimonial/testimonial.feedback_placeholder') }}"></textarea>
