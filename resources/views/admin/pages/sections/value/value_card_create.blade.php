            ...
            <div class="col-lg-12">
                <div class="card-group d-block d-md-flex row">
                    <div class="card col-md-7 p-2 mb-4">
                        ...
                        <form method="POST" action="{{route('admin.value_card.store')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                <div class="example">
                                    ...
                                    <div class="tab-content rounded-bottom" id="content_tab">
                                      <div class="tab-pane p-3 active preview" role="tabpanel" >
                                        ...
                                        <div class="alert alert-success alert-dismissible fade show" role="alert">
                                            {{__('admin/value/value-index.created')}}
                                            ...
                                            <section id="values" class="values">
                                                <div class="container" data-aos="fade-up">
                                                  ...
                                                  <div class="row" style="justify-content: center">
                                                    ...
                                                    <div class="col-lg-4 mb-3" data-aos="fade-up" data-aos-delay="200">
                                                        <div class="box">
                                                          <img id="preview_image" src="{{(asset('frontend/assets/img/values-1.png'))}}" class="img-fluid" alt="">
                                                          <h3 id="preview_title">{!!__('admin/value/value-index.title_placeholder')!!}</h3>
                                                          <p id="preview_description"'>{!!__('admin/value/value-index.description_placeholder')!!}</p>
                                                        </div>
                                                    </div>
                                                  </div>
                                                </div>
