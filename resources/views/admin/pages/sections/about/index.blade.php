            ...
            <div class="col-lg-12">
                <div class="card-group d-block d-md-flex row">
                    <div class="card col-md-7 p-2 mb-4">
                        <div class="card-header"><h2>{{__('admin/about/about-index.edit')}}</h2></div>
                        <form method="POST" action="{{$about == null ? route('admin.about.store') : route('admin.about.update', $about->id) }}" enctype="multipart/form-data">
                            @csrf
                            @if ($about)
                            @method('PATCH')
                            @endif
                                    ...
                                    <div class="tab-content rounded-bottom" id="content_tab">
                                      <div class="tab-pane p-3 active preview" role="tabpanel" >
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input class="form-control" id="question" name="question" type="text" placeholder="{{__('admin/about/about-index.question-placeholder')}}"
                                        ...
                                        <div class="form-group mb-3">
                                            <label class="form-label">{{__('admin/about/about-index.title')}}</label>
                                            <textarea class="form-control" rows="5" id="title" name="title" type="text" placeholder="{{__('admin/about/about-index.title_placeholder')}}"
                                            onchange="loadDocument(event, 'preview_title')"
                                            onkeypress="detectEnterline(event, 'title'); loadDocument(event, 'preview_title')"
                                            >{{$about ? ($about->title === '' ? old('title') : $about->title) : ''}}</textarea>
                                            @if ($errors->has('title'))
                                                <div class="row mb-0">
                                        ...
                                        <div class="form-group mb-3">
                                            <label class="form-label">{{__('admin/about/about-index.summary')}}</label>
                                            <textarea class="form-control" rows="5" id="summary" name="summary" type="text" placeholder="{{__('admin/about/about-index.summary_placeholder')}}"
                                            onchange="loadDocument(event, 'preview_summary')"
                                            onkeypress="detectEnterline(event, 'summary'); loadDocument(event, 'preview_summary')"
                                            >{{$about ? ($about->summary === '' ? old('summary') : $about->summary) : ''}}</textarea>
                                            @if ($errors->has('summary'))
                                                <div class="row mb-0">
                                                    <div class="invalid-feedback" style="display: inline;">{{$errors->first('summary')}}</div>
                                                </div>
                                            @endif
                                        </div>
                                        <div class="form-group mb-3">
                                        ...
                                        <div class="form-group mb-3">
                                            <label class="form-label">{{__('admin/about/about-index.button_url')}}</label>
                                            <input class="form-control" id="button_url" name="button_url" type="url"
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <select class="form-select" id="status" name="status">
                                                <option {!!$about ? ($about->status == 1 ? 'selected' : '') : 'selected'!!} value="1">{{__('admin/common.display')}}</option>
                                                <option {!!$about ? ($about->status == 0 ? 'selected' : '') : ''!!} value="0">{{__('admin/common.hide')}}</option>
                                            </select>
                                        </div>
                                      </div>
                                    </div>
                                                ...
                                                <div class="container mt-5" data-aos="fade-up">
                                                  <div class="row">
                                                    <div class="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
                                                      <div class="content">
                                                        <h3 id="preview_question">{{$about ? ($about->question === '' ? __('admin/about/about-index.question-placeholder') : $about->question) : __('admin/about/about-index.question-placeholder')}}</h3>
                                                        <h2 id="preview_title">{!!$about ? ($about->title === '' ? __('admin/about/about-index.title_placeholder') : $about->title) : __('admin/about/about-index.title_placeholder')!!}</h2>
                                                        <p id="preview_summary">{!!$about ? ($about->summary === '' ? __('admin/about/about-index.summary_placeholder') : $about->summary) : __('admin/about/about-index.summary_placeholder')!!}</p>
                                                        <div class="text-center text-lg-start">
                                                          <a href="{{$about ? ($about->button_url === '' ? '#' : $about->button_url) : '#'}}" class="btn-read-more d-inline-flex align-items-center justify-content-center align-self-center">
                                                            <span id="preview_button_text">{{$about ? ($about->button_text === '' ? __('admin/common.read_more') : $about->button_text) : __('admin/common.read_more')}}</span>
                                                    ...
                                                    <div class="col-lg-6 d-flex align-items-center" data-aos="zoom-out" data-aos-delay="200">
                                                      <img id="preview_image" src="{{$about ? ($about->image === '' ? asset('frontend/assets/img/about.jpg') : asset($about->image)) : asset('frontend/assets/img/about.jpg')}}" class="img-fluid" alt="">
                                                    </div>
                                                  </div>
                                                </div>
                                            </section>
