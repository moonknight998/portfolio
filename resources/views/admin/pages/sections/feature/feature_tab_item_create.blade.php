                    ...
                    <div class="card-group d-block d-md-flex row">
                        <div class="card col-md-7 p-2 mb-4">
                            <div class="card-header">
                                <h2>{{ __('admin/feature/feature.create_tab_item') }}</h2>
                            </div>
                            <form method="POST" action="{{ route('admin.feature_tab_item.store') }}"
                                            ...
                                            <div class="tab-pane p-3 active preview" role="tabpanel">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input class="form-control" id="tab_id" name="tab_id" type="text"
                                                        ...
                                                        value="tab{{ count($feature_tab_items) + 1 }}">
                                                                    ...
                                                                    @if (count($feature_tab_items) > 0)
                                                                        @foreach ($feature_tab_items as $feature_tab_item_local)
                                                                            <div class="tab-pane fade"
                                                                                ...
                                                                                <p>{{ $feature_tab_item_local->first_description }}
                                                                                </p>
                                                                                <div
                                                                                    class="d-flex align-items-center mb-2">
                                                                                    <i class="bi bi-check2"></i>
                                                                                    <h4>{{ $feature_tab_item_local->first_title }}
                                                                                    </h4>
                                                                                </div>
                                                                                <p>{{ $feature_tab_item_local->second_description }}
                                                                                </p>
                                                                                <div
                                                                                    class="d-flex align-items-center mb-2">
                                                                                    <i class="bi bi-check2"></i>
                                                                                    <h4>{{ $feature_tab_item_local->second_title }}
                                                                                    </h4>
                                                                                </div>
                                                                                <p>{{ $feature_tab_item_local->third_description }}
                                                                                </p>
                                                                            </div>
                                                                        @endforeach
                                                                    @endif
                                                                    <div class="tab-pane fade show active"
                                                                        id="tab{{ count($feature_tab_items) + 1 }}">
                                                                        <p id="preview_first_description">
                                                                            {{ __('admin/feature/feature.tab_item_first_description_placeholder') }}
                                                                        </p>
                                                                        <div class="d-flex align-items-center mb-2">
                                                                            <i class="bi bi-check2"></i>
                                                                            <h4 id="preview_first_title">
                                                                                {{ __('admin/feature/feature.tab_item_first_title_placeholder') }}
                                                                            </h4>
                                                                        </div>
                                                                        <p id="preview_second_description">
                                                                            {{ __('admin/feature/feature.tab_item_second_description_placeholder') }}
                                                                        </p>
                                                                        <div class="d-flex align-items-center mb-2">
                                                                            <i class="bi bi-check2"></i>
                                                                            <h4 id="preview_second_title">
                                                                                {{ __('admin/feature/feature.tab_item_second_title_placeholder') }}
                                                                            </h4>
                                                                        </div>
                                                                        <p id="preview_third_description">
                                                                            {{ __('admin/feature/feature.tab_item_third_description_placeholder') }}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </div>
