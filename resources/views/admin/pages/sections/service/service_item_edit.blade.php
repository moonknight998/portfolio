                ...
                <div class="col-lg-12">
                    <div class="card-group d-block d-md-flex row">
                        <div class="card col-md-7 p-2 mb-4">
                            ...
                            <form method="POST" action="{{ route('admin.service_item.update', $service_item->id) }}"
                                            ...
                                            <div class="tab-pane p-3 active preview" role="tabpanel">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input class="form-control" id="button_text" required name="button_text"
                                                        ...
                                                        value="{{ $service_item->button_text }}"
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input class="form-control form-control-color" id="main_color"
                                                        name="main_color" type="color"
                                                        value="{{ $service_item->main_color }}"
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input class="form-control form-control-color" id="extra_color"
                                                        name="extra_color" type="color"
                                                        value="{{ $service_item->extra_color }}"
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <select class="form-select" id="status" name="status">
                                                        <option {{ $service_item->status == 1 ? 'selected' : '' }}
                                                            value="1">{{ __('admin/common.display') }}</option>
                                                        <option {{ $service_item->status == 0 ? 'selected' : '' }}
                                                                        ...
                                                                        <div class="col-lg-4 col-md-6 aos-init aos-animate"
                                                                            ...
                                                                            <div id="border{{ $loop->index }}"
                                                                                ...
                                                                                <i id="icon{{ $loop->index }}"
                                                                                    class="{{ $service_item_local->icon }} icon-backend"
                                                                                    style="color: {{ $service_item_local->main_color }}; background: {{ $service_item_local->extra_color }}; padding: 20px 20px;"></i>
                                                                                <h3>{{ $service_item_local->title }}</h3>
                                                                                <p>{{ $service_item_local->description }}
                                                                                </p>
                                                                                <a id="url{{ $loop->index }}"
                                                                                    href="{{ $service_item_local->button_url }}"
                                                                                    target="_blank" class="read-more"
                                                                                    style="color: {{ $service_item_local->main_color }};"><span>{{ $service_item_local->button_text }}</span><i
                                                                                        class="bi bi-arrow-right"></i></a>
                                                                            </div>
                                                                        </div>
                                                                    @endif
