                                                    ...
                                                    <div class="row" style="margin-top: 50pt">
                                                        <div class="col-lg-8 entries">
                                                            <article class="entry entry-single">
                                                                <div class="entry-img">
                                                                    <img class="post-thumbnail" id="preview_thumbnail" src="{{$blog_post->thumbnail}}" alt="">
                                                                </div>
                                                                ...
                                                                <div class="entry-footer">
                                                                    ...
                                                                    <ul class="cats">
                                                                        <li><a id="preview_category">{{$blog_post->category->category_name}}</a></li>
                                                                    </ul>
                                                                </div>
