                ...
                <div class="col-lg-12">
                    <div class="card-group d-block d-md-flex row">
                        <div class="card col-md-7 p-2 mb-4">
                            ...
                            <form method="POST" action="{{ route('admin.pricing_item.store') }}"
                                            ...
                                            <div class="tab-pane p-3 active preview" role="tabpanel">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input class="form-control form-control-color" id="color"
                                                        name="color" type="color" value="#07d5c0"
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <select class="form-select" id="is_featured" name="is_featured"
                                                        ...
                                                        <option selected value="0">{{ __('admin/common.hide') }}
                                                        </option>
                                                    </select>
                                                </div>
                                                <div class="form-group mb-3">
                                                        ...
                                                        <div class="row gy-4" data-aos="fade-left"
                                                            ...
                                                            @foreach ($pricing_items as $pricing_item)
                                                                <div class="col-lg-3 col-md-6" data-aos="zoom-in"
                                                                    ...
                                                                    <div class="box">
                                                                        <span class="featured"
                                                                            style="display: {{ $pricing_item->is_featured ? 'block' : 'none' }}">{{ __('admin/common.featured') }}</span>
                                                                        <h3 style="color: {{ $pricing_item->color }};">
                                                                            {{ $pricing_item->pricing_name }}</h3>
                                                                        <div class="price">
                                                                            <span
                                                                                style="font-size: 1.5rem; color:rgb(65, 65, 65); font-weight:bold;">{{ $pricing_item->price_per_month }}</span>
                                                                            <sup> {{ $pricing_item->currency }}</sup>
                                                                            <span> / {{ __('admin/common.month') }}</span>
                                                                        </div>
                                                                        <img src="{{ isset($pricing_item->image) ? $pricing_item->image : asset('frontend/assets/img/pricing-free.png') }}"
                                                                            class="img-fluid" alt="">
                                                                        <ul>
                                                                            <p
                                                                                style="line-height: 3rem;margin: 0px 20px 10px 20px;font-size: 18px;">
                                                                                {!! $pricing_item->benefit !!}</p>
                                                                        </ul>
                                                                        <a href="#"
                                                                            class="btn-buy">{{ $pricing_item->button_name }}</a>
                                                                    </div>
                                                                </div>
                                                            @endforeach
                                                            <div class="col-lg-3 col-md-6" data-aos="zoom-in"
                                                                data-aos-delay="100" style="display: flex">
                                                                <div class="box">
                                                                    <span id="preview_is_featured" class="featured"
                                                                        style="display: none">{{ __('admin/common.featured') }}</span>
                                                                    <h3 id="preview_pricing_name" style="color: #07d5c0;">
                                                                        {{ __('admin/pricing/pricing.pricing_name') }}</h3>
                                                                    <div class="price">
                                                                        <span id="preview_price_per_month"
                                                                            style="font-size: 2.125rem; color:rgb(65, 65, 65); font-weight:bold;">0</span>
                                                                        <sup id="preview_currency"> VND</sup>
                                                                        <span> / {{ __('admin/common.month') }}</span>
                                                                    </div>
                                                                    <img id="preview_image"
                                                                        src="{{ asset('frontend/assets/img/pricing-free.png') }}"
                                                                        class="img-fluid" alt="">
                                                                    <ul>
                                                                        <p id="preview_benefit"
                                                                            style="line-height: 3rem;margin: 0px 20px 10px 20px;font-size: 18px;">
                                                                            {{ __('admin/pricing/pricing.benefit') }}</p>
                                                                    </ul>
                                                                    <a id="preview_button_name" href="#"
