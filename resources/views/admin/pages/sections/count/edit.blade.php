                                            ...
                                            <div class="tab-pane p-3 active preview" role="tabpanel">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input class="form-control" id="quantity" required name="quantity"
                                                        ...
                                                        onchange="changeAttribute(event, 'preview_quantity', 'data-purecounter-end')"></input>
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input class="form-control form-control-color" id="icon_color"
                                                        name="icon_color" type="color" value="{{ $count->icon_color }}"
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <select class="form-select" id="status" name="status">
                                                        <option {{ $count->status == 1 ? 'selected' : '' }}
                                                            value="1">{{ __('admin/common.display') }}</option>
                                                        <option {{ $count->status == 0 ? 'selected' : '' }}
                                                            ...
                                                            @if ($counts)
                                                                @foreach ($counts as $count_item)
                                                                    <div class="col-lg-3 col-md-6">
                                                                        <div class="count-box">
                                                                            <i id="{{ $count_item->id == $count->id ? 'preview_icon' : '' }}"
                                                                                class="{{ $count_item->icon }}"
                                                                                style="color: {{ $count_item->icon_color }}"></i>
                                                                            <div>
                                                                                <span
                                                                                    id="{{ $count_item->id == $count->id ? 'preview_quantity' : '' }}"
                                                                                    data-purecounter-start="0"
                                                                                    data-purecounter-end="{{ $count_item->quantity }}"
                                                                                    data-purecounter-duration="1"
                                                                                    class="purecounter">1</span>
                                                                                <p
                                                                                    id="{{ $count_item->id == $count->id ? 'preview_title' : '' }}">
                                                                                    {{ $count_item->title }}</p>
                                                                            </div>
                                                                        </div>
                                                                    </div>
