            ...
            <div class="col-lg-12">
                <div class="card-group d-block d-md-flex row">
                    <div class="card col-md-7 p-2 mb-4">
                        ...
                        <form method="POST" action="{{$blog_title == null ? route('admin.blog_title.store') : route('admin.blog_title.update', $blog_title->id)}}" enctype="multipart/form-data">
                            @csrf
                            @if ($blog_title)
                            @method('PATCH')
                            @endif
                                    ...
                                    <div class="tab-content rounded-bottom" id="content_tab">
                                      <div class="tab-pane p-3 active preview" role="tabpanel" >
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            >{{ShowFormValue($blog_title, "title")}}</textarea>
                                            @if ($errors->has('title'))
                                                <div class="row mb-0">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <select class="form-select" id="status" name="status">
                                                <option {{$blog_title ? ($blog_title->status == 1 ? 'selected' : '') : 'selected'}} value="1">{{__('admin/common.display')}}</option>
                                                <option {{$blog_title ? ($blog_title->status == 0 ? 'selected' : '') : ''}} value="0">{{__('admin/common.hide')}}</option>
                                            </select>
                                        </div>
                                      </div>
                                    </div>
                                            ...
                                            <section class="recent-blog-posts" id="recent-blog-posts">
                                                <div class="container" data-aos="fade-up">
                                                    <header class="section-header">
                                                        <h2 id="preview_section_name">{{ShowTextData($blog_title, 'section_name', __('admin/common.section_name_preview'))}}</h2>
                                                        <p id="preview_title">{{ShowTextData($blog_title, 'title',__('admin/common.title_preview'))}}</p>
                                                    </header>
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <div class="post-box">
