            ...
            <div class="col-lg-12">
                <div class="card-group d-block d-md-flex row">
                    <div class="card col-md-7 p-2 mb-4">
                        ...
                        <form method="POST" action="{{route('admin.value_card.update', $value_card->id)}}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                <div class="example">
                                    ...
                                    <div class="tab-content rounded-bottom" id="content_tab">
                                      <div class="tab-pane p-3 active preview" role="tabpanel" >
                                        ...
                                        <div class="form-group mb-3">
                                            <label class="form-label">{{__('admin/value/value-index.title')}}</label>
                                            <input class="form-control" id="title" name="title" type="text" placeholder="{{__('admin/value/value-index.title_placeholder')}}"
                                        ...
                                        <div class="form-group mb-3">
                                            <label class="form-label">{{__('admin/value/value-index.description')}}</label>
                                            <textarea class="form-control" rows="5" id="description" name="description" type="text" placeholder="{{__('admin/value/value-index.description_placeholder')}}"
                                            ...
                                            >{{$value_card->description}}</textarea>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <select class="form-select" id="status" name="status">
                                                <option {!!$value_card->status == 1 ? 'selected' : ''!!} value="1">{{__('admin/common.display')}}</option>
                                                <option {!!$value_card->status == 0 ? 'selected' : ''!!} value="0">{{__('admin/common.hide')}}</option>
                                            </select>
                                        </div>
                                      </div>
                                    </div>
                                                ...
                                                <div class="container" data-aos="fade-up">
                                                  ...
                                                  <div class="row" style="justify-content: center">
                                                    ...
                                                    <div class="col-lg-4 mb-3" data-aos="fade-up" data-aos-delay="200">
                                                        <div class="box">
                                                          <img id="{{$value_card_item->id == $value_card->id ? 'preview_image' : ''}}" src="{{$value_card_item->image === '' ? (asset('frontend/assets/img/values-1.png')) : asset($value_card_item->image)}}" class="img-fluid" alt="">
                                                          <h3 id="{{$value_card_item->id == $value_card->id ? 'preview_title' : ''}}">{!!$value_card_item->title!!}</h3>
                                                          <p id="{{$value_card_item->id == $value_card->id ? 'preview_description' : ''}}">{!!$value_card_item->description!!}</p>
                                                        </div>
                                                      </div>
                                                    @endforeach
                                                  </div>
