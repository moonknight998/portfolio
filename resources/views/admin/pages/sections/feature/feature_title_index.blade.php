                ...
                <div class="col-lg-12">
                    <div class="card-group d-block d-md-flex row">
                        <div class="card col-md-7 p-2 mb-4">
                            ...
                            <form method="POST"
                                action="{{ $feature_title == null ? route('admin.feature_title.store') : route('admin.feature_title.update', $feature_title->id) }}"
                                            ...
                                            <div class="tab-pane p-3 active preview" role="tabpanel">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <textarea class="form-control" rows="5" id="title" name="title" type="text"
                                                        ...
                                                        onkeypress="detectEnterline(event, 'title'); loadDocument(event, 'preview_title')">{{ $feature_title ? ($feature_title->title === '' ? old('title') : $feature_title->title) : '' }}</textarea>
                                                    @if ($errors->has('title'))
                                                        <div class="row mb-0">
                                                            <div class="invalid-feedback" style="display: inline;">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <select class="form-select" id="status" name="status">
                                                        <option
                                                            {{ $feature_title ? ($feature_title->status == 1 ? 'selected' : '') : 'selected' }}
                                                            value="1">{{ __('admin/common.display') }}</option>
                                                        <option
                                                            {{ $feature_title ? ($feature_title->status == 0 ? 'selected' : '') : '' }}
                                                            ...
                                                            @if ($feature_title && $feature_title->status == 1)
                                                                <div class="col-lg-6"
                                                                    ...
                                                                    <img id="preview_image"
                                                                        src="{{ $feature_title->image ? asset($feature_title->image) : asset('/frontend/assets/img/features.png') }}"
                                                                        class="img-fluid" alt="">
                                                                </div>
                                                            @else
                                                                <div class="col-lg-6"
                                                                    style="display: flex; justify-content: center; align-content: center;">
                                                                    <img id="preview_image"
                                                                        src="{{ asset('/frontend/assets/img/features.png') }}"
                                                                        class="img-fluid" alt="">
                                                                </div>
                                                            @endif
                                                                    ...
                                                                    <div class="row-md-6 align-self-center gy-4"
                                                                        ...
                                                                        <div class="col-md-6 aos-init aos-animate py-1"
                                                                            ...
                                                                            <div class="feature-box d-flex align-items-center"
                                                                                ...
                                                                                <h3>{{ __('admin/feature/feature.title_placeholder') }}
                                                                                </h3>
                                                                            </div>
                                                                        </div>
                                                                    </div>
