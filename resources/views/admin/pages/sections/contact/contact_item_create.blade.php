                    ...
                    <div class="card-group d-block d-md-flex row">
                        <div class="card col-md-7 p-2 mb-4">
                            ...
                            <form method="POST" id="data-form" class="was-validated" novalidate
                                action="{{ route('admin.contact_item.store') }}"
                                            ...
                                            <div class="tab-pane p-3 active preview" role="tabpanel">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input class="form-control" id="icon" name="icon"
                                                        type="text"
                                                        onchange="changeAttribute(event, 'preview_icon', 'class')" value="bi bi-geo-alt" required>
                                                    @if ($errors->has('icon'))
                                                        <div class="row mb-0">
                                                            <div class="invalid-feedback" style="display: inline;">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <select class="form-select" id="status" name="status" required>
                                                        <option
                                                            selected value="1">{{ __('admin/common.display') }}</option>
                                                        <option
                                                        ...
                                                        <div class="row gy-4">
                                                            <div class="col-lg-6">
                                                                <div class="row gy-4">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="info-box">
                                                                            <i id="preview_icon" class="bi bi-geo-alt"></i>
                                                                            <h3 id="preview_title">@lang('admin/common.title')</h3>
                                                                            <p id="preview_first_line">@lang('admin/contact/contact.first_line')</p>
                                                                            <p id="preview_second_line">@lang('admin/contact/contact.second_line')</p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
