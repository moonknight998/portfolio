                ...
                <div class="col-lg-12">
                    <div class="card-group d-block d-md-flex row">
                        <div class="card col-md-7 p-2 mb-4">
                            ...
                            <form method="POST" action="{{ route('admin.value_card.store') }}"
                                            ...
                                            <div class="tab-pane p-3 active preview" role="tabpanel">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <textarea class="form-control" rows="5" id="description" name="description" type="text"
                                                        ...
                                                        onkeypress="detectEnterline(event, 'description'); loadDocument(event, 'preview_description')"></textarea>
                                                            ...
                                                            <div class="col-lg-4 mb-3" data-aos="fade-up"
                                                                ...
                                                                <div class="box">
                                                                    <img id="preview_image"
                                                                        src="{{ asset('frontend/assets/img/values-1.png') }}"
                                                                        class="img-fluid" alt="">
                                                                    <h3 id="preview_title">{!! __('admin/value/value-index.title_placeholder') !!}</h3>
                                                                    <p id="preview_description"'>{!! __('admin/value/value-index.description_placeholder') !!}
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </div>
