            ...
            <div class="col-lg-12">
                <div class="card-group d-block d-md-flex row">
                    <div class="card col-md-7 p-2 mb-4">
                        ...
                        <form method="POST" action="{{route('admin.testimonial_item.store')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                <div class="example">
                                      ...
                                      <div class="tab-pane p-3 active preview" role="tabpanel" >
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <select class="form-select" id="rated" name="rated">
                                                ...
                                                <option selected value="5">5 {{__('admin/common.star')}}</option>
                                            </select>
                                        </div>
                                        <div class="form-group mb-3">
                                            ...
                                            onkeypress="detectEnterline(event, 'feedback'); loadDocument(event, 'preview_feedback')" placeholder="{{__('admin/testimonial/testimonial.feedback_placeholder')}}"></textarea>
