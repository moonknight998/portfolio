                ...
                <div class="col-lg-12">
                    <div class="card-group d-block d-md-flex row">
                        <div class="card col-md-7 p-2 mb-4">
                            ...
                            <form method="POST" action="{{ route('blog.blog_category.update', $blog_category->id) }}"
                                ...
                                <div class="card-body">
                                    <div class="example">
                                        <ul class="nav nav-tabs" role="tablist">
                                            ...
                                            <li class="d-none nav-item" role="presentation"><a class="nav-link"
                                        ...
                                        <div class="tab-content rounded-bottom" id="content_tab">
                                            <div class="tab-pane p-3 active preview" role="tabpanel">
                                                ...
                                                <div class="form-group mb-3">
                                                    <label
                                                        class="form-label">{{ __('admin/blog/blog.category_name') }}</label>
                                                    <input class="form-control" id="category_name" name="category_name"
                                                        type="text"
                                                        placeholder="{{ __('admin/blog/blog.category_name_placeholder') }}"
                                                        onchange="loadDocument(event, 'preview_category_name')"
                                                        value="{{ $blog_category->category_name }}"></input>
