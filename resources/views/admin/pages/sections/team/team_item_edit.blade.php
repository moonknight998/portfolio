                ...
                <div class="col-lg-12">
                    <div class="card-group d-block d-md-flex row">
                        <div class="card col-md-7 p-2 mb-4">
                            ...
                            <form method="POST" action="{{ route('admin.team_item.update', $team_item->id) }}"
                                            ...
                                            <div class="tab-pane p-3 active preview" role="tabpanel">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input class="form-control" id="work_title" name="work_title"
                                                        ...
                                                        onchange="loadDocument(event, 'preview_work_title')"
                                                        value="{{ $team_item->work_title }}"></input>
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input class="form-control" id="facebook_url" name="facebook_url"
                                                        ...
                                                        value="{{ $team_item->facebook_url }}"></input>
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input class="form-control" id="instagram_url" name="instagram_url"
                                                        ...
                                                        value="{{ $team_item->instagram_url }}"></input>
                                                    @if ($errors->has('name'))
                                                        <div class="row mb-0">
                                                            <div class="invalid-feedback" style="display: inline;">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input class="form-control" id="telegram_url" name="telegram_url"
                                                        ...
                                                        value="{{ $team_item->telegram_url }}"></input>
                                                    @if ($errors->has('name'))
                                                        <div class="row mb-0">
                                                            <div class="invalid-feedback" style="display: inline;">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <select class="form-select" id="status" name="status">
                                                        <option {{ $team_item->status == 1 ? 'selected' : '' }}
                                                            value="1">{{ __('admin/common.display') }}</option>
                                                        <option {{ $team_item->status == 0 ? 'selected' : '' }}
                                                                            ...
                                                                            <div class="member">
                                                                                <div class="member-img">
                                                                                    <img id="preview_image"
                                                                                        src="{{ $team_item_local->image }}"
                                                                                        class="img-fluid mem-img"
                                                                                        alt="">
                                                                                    <div class="social">
                                                                                        <a id="preview_facebook_url"
                                                                                            href="{{ $team_item_local->facebook_url }}"
                                                                                            target="_blank"><i
                                                                                                class="bi bi-facebook"></i></a>
                                                                                        {{-- <a href=""><i class="bi bi-twitter"></i></a> --}}
                                                                                        <a id="preview_instagram_url"
                                                                                            href="{{ $team_item_local->instagram_url }}"
                                                                                            target="_blank"><i
                                                                                                class="bi bi-instagram"></i></a>
                                                                                        <a id="preview_telegram_url"
                                                                                            href="{{ $team_item_local->telegram_url }}"
                                                                                            target="_blank"><i
                                                                                ...
                                                                                <div class="member-info">
                                                                                    <h4 id="preview_name">
                                                                                        {{ $team_item_local->name }}</h4>
                                                                                    <span
                                                                                        id="preview_work_title">{{ $team_item_local->work_title }}</span>
                                                                                    <p id="preview_description">
                                                                                        {{ $team_item_local->description }}
                                                                                    </p>
                                                                                </div>
                                                                            </div>
                                                                        </div>
