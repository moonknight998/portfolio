                    ...
                    <div class="card-group d-block d-md-flex row">
                        <div class="card col-md-7 p-2 mb-4">
                            <div class="card-header">
                                <h2>{{ __('admin/hero/hero-index.edit') }}</h2>
                            </div>
                            <form method="POST"
                                action="{{ $hero ? route('admin.hero.update', $hero->id) : route('admin.hero.store') }}"
                                        ...
                                        <div class="tab-content rounded-bottom" id="content_tab">
                                            <div class="tab-pane p-3 active preview" role="tabpanel">
                                                ...
                                                <div class="form-group mb-3">
                                                    <label
                                                        class="form-label">{{ __('admin/hero/hero-index.slogan') }}</label>
                                                    <input class="form-control" id="slogan" name="slogan" type="text"
                                                        placeholder="{{ __('admin/hero/hero-index.slogan-placeholder') }}"
                                                ...
                                                <div class="form-group mb-3">
                                                    <label
                                                        class="form-label">{{ __('admin/hero/hero-index.short-description') }}</label>
                                                    <textarea class="form-control" rows="3" id="short_description" name="short_description" type="text"
                                                        placeholder="{{ __('admin/hero/hero-index.short-description-placeholder') }}"
                                                        onchange="loadDocument(event, 'preview_short_description')"
                                                        onkeypress="detectEnterline(event, 'short_description'); loadDocument(event, 'preview_short_description')">{{ $hero ? ($hero->short_description === '' ? old('short_description') : $hero->short_description) : '' }}</textarea>
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input class="form-control" id="button_text" name="button_text"
                                                        type="text" placeholder="{{ __('admin/common.get_started') }}"
                                                ...
                                                <div class="form-group mb-3">
                                                    <label
                                                        class="form-label">{{ __('admin/hero/hero-index.button-url') }}</label>
                                                    <input class="form-control" id="button_url" readonly name="button_url"
                                                        type="url" value="about" style="background-color: gray">
                                                </div>
                                                <div class="form-group mb-3">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <select class="form-select" id="status" name="status">
                                                        <option {!! $hero ? ($hero->status == 1 ? 'selected' : '') : 'selected' !!} value="1">
                                                            {{ __('admin/common.display') }}</option>
                                                        <option {!! $hero ? ($hero->status == 0 ? 'selected' : '') : '' !!} value="0">
                                                    ...
                                                    <div class="container">
                                                        <div class="row">
                                                            <div
                                                                ...
                                                                <h1 data-aos="fade-up" id="preview_slogan">
                                                                    {{ $hero ? ($hero->slogan === '' ? __('admin/hero/hero-index.slogan-placeholder') : $hero->slogan) : __('admin/hero/hero-index.slogan-placeholder') }}
                                                                </h1>
                                                                <h2 data-aos="fade-up" data-aos-delay="400"
                                                                    id="preview_short_description">{!! $hero
                                                                        ? ($hero->short_description === ''
                                                                            ? __('admin/hero/hero-index.short-description-placeholder')
                                                                            : $hero->short_description)
                                                                        : __('admin/hero/hero-index.short-description-placeholder') !!}
                                                                </h2>
                                                                <div data-aos="fade-up" data-aos-delay="600">
                                                                    <div class="text-center text-lg-start">
                                                                        <a href="#{{ $hero ? ($hero->button_url === '' ? 'about' : $hero->button_url) : 'about' }}"
                                                                            ...
                                                                            <span
                                                                                id="preview_button_text">{{ $hero ? ($hero->button_text === '' ? __('admin/common.get_started') : $hero->button_text) : __('admin/common.get_started') }}</span>
                                                            ...
                                                            <div class="col-lg-6 hero-img" data-aos="zoom-out"
                                                                ...
                                                                <img id="preview_image"
                                                                    src="{{ $hero ? ($hero->image === '' ? asset('frontend/assets/img/hero-img.png') : $hero->image) : asset('frontend/assets/img/hero-img.png') }}"
                                                                    class="img-fluid" alt="">
                                                            </div>
                                                        </div>
                                                    </div>
