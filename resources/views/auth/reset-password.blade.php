    ...
    * Licensed under MIT (https://github.com/coreui/coreui-free-bootstrap-admin-template/blob/main/LICENSE)
    ...
    <html lang="vi">
      <head>
        ...
        <title>{{__('resetpassword.reset_password')}}</title>
        <!-- CSS Libraries -->
              ...
              <div class="col-lg-4">
                <div class="card-group d-block d-md-flex row">
                  <div class="card col-md-7 p-4 mb-0">
                    <div class="card-body">
                      <h1>{{__('resetpassword.reset_password')}}</h1>
                      <p class="text-medium-emphasis">{{__('resetpassword.reset_your_password')}}</p>
                      ...
                      <form method="POST" action="{{route('password.store')}}">
                        ...
                        <div class="row mb-2">
                            <div class="input-group mb-1"><span class="input-group-text">
                              ...
                              <input id="email" class="form-control" type="email" placeholder="{{__('resetpassword.email')}}" name="email" value="{{$request->email}}">
                              @if ($errors->has('email'))
                        ...
                        <div class="row mb-2">
                            <div class="input-group mb-1"><span class="input-group-text">
                              ...
                              <input id="password" class="form-control" type="password" placeholder="{{__('resetpassword.password')}}" name="password">
                        ...
                        <div class="row mb-2">
                            <div class="input-group mb-1"><span class="input-group-text">
                              ...
                              <input id="password_confirmation" class="form-control" type="password" placeholder="{{__('resetpassword.confirm_password')}}" name="password_confirmation">
                        ...
                        <div class="row justify-content-end">
                          <div class="col-6">
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary px-4 rounded-pill" style="float: right;">{{__('resetpassword.reset_password')}}</button>
                            </div>
                          </div>
                        </div>
                      </form>
