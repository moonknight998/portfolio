                    ...
                    <div class="card-group d-block d-md-flex row">
                        <div class="card col-md-7 p-2 mb-4">
                            <div class="card-header">
                                <h2>{{ __('admin/feature/feature.create_icon_item') }}</h2>
                            </div>
                            <form method="POST" action="{{ route('admin.feature_icon_item.store') }}"
                                        ...
                                        <div class="tab-content rounded-bottom" id="content_tab">
                                            <div class="tab-pane p-3 active preview" role="tabpanel">
                                                ...
                                                <div class="form-group mb-3">
                                                    <label class="form-label">{{ __('admin/feature/feature.title') }}
                                                        (*)</label>
                                                ...
                                                <div class="form-group mb-3">
                                                    <label class="form-label">{{ __('admin/feature/feature.description') }}
                                                        (*)</label>
                                                            ...
                                                            <div class="col-xl-8 d-flex content">
                                                                <div class="row align-self-center gy-4"
                                                                    ...
                                                                    <div class="col-md-6 icon-box aos-init aos-animate"
                                                                        ...
                                                                        <div>
                                                                            <h4 id="preview_item_title">
                                                                                {{ __('admin/common.title_preview') }}</h4>
