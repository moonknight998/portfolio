                    ...
                    <div class="card-group d-block d-md-flex row">
                        <div class="card col-md-7 p-2 mb-4">
                            <div class="card-header">
                                ...
                                <a href="{{ route('admin.contact_item.create') }}"
                                        ...
                                        <tbody>
                                            @foreach ($contact_items_paginate as $contact_item_local)
                                                <tr class="align-middle">
                                                    ...
                                                    <td class="text-center"><i class="{{ $contact_item_local->icon }}"></i>
                                                    </td>
                                                    <td style="width: 100px">
                                                        <div class="form-check form-switch"
                                                            style="display: flex; justify-content: center">
                                                            <input class="form-check-input change-status"
                                                                {{ $contact_item_local->status == 1 ? 'checked' : '' }}
                                                                data-id="{{ $contact_item_local->id }}" type="checkbox"
                                                                role="switch" id="flexSwitchCheckChecked">
                                                        </div>
                                                    </td>
                                                    <td style="width: 200px">
                                                        <div style="display: flex; justify-content: center; gap: 5px">
                                                            <a href="{{ route('admin.contact_item.edit', $contact_item_local->id) }}"
                                                                class="btn btn-success edit-btn">{{ __('admin/common.edit') }}
                                                                <i class="fas fa-pen"></i></a>
                                                            <a href="{{ route('admin.contact_item.destroy', $contact_item_local->id) }}"
