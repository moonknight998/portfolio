        ...
        <div class="container-fluid px-4">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb my-0">
                    ...
                    <li class="breadcrumb-item active"><a>{{ __('admin/privacypolicy/privacypolicy.update_section') }}</a>
                    </li>
                </ol>
            </nav>
        </div>
                    ...
                    <div class="card-group d-block d-md-flex row">
                        <div class="card col-md-7 p-2 mb-4">
                            ...
                            <form class="was-validated" novalidate method="POST"
                                action="{{ $privacy_policy ? route('admin.privacy_policy.update', $privacy_policy->id) : route('admin.privacy_policy.store') }}"
                                            ...
                                            <div class="tab-pane p-3 active preview" role="tabpanel">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input class="form-control" name="title" type="text"
                                                        ...
                                                        value="{{ $privacy_policy ? $privacy_policy->title : '' }}"></input>
                                                    @if ($errors->has('title'))
                                                        <div class="row mb-0">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <select class="form-select" id="status" name="status" required>
                                                        <option
                                                            {{ $privacy_policy ? ($privacy_policy->status == 1 ? 'selected' : '') : 'selected' }}
                                                            value="1">{{ __('admin/common.display') }}</option>
                                                        <option
                                                            {{ $privacy_policy ? ($privacy_policy->status == 0 ? 'selected' : '') : '' }}value="0">
                                                        ...
                                                        <div class="col-lg-12 entries">
                                                            <article class="entry entry-single">
                                                                <h2 class="entry-title">
                                                                    <a
                                                                        id="preview_title">{{ $privacy_policy ? $privacy_policy->title : __('admin/privacypolicy/privacypolicy.title_preview') }}</a>
                                                                </h2>
                                                                <div class="entry-meta">
                                                                    <ul>
                                                                        ...
                                                                        <li class="d-flex align-items-center"><i
                                                                                class="bi bi-clock"></i><a><time>{{ $privacy_policy ? __('admin/common.updated_at') . ':' . ' ' . date('d-m-Y', strtotime($privacy_policy->updated_at)) : __('admin/common.updated_at') . ':' . ' ' . date('d-m-Y') }}</time></a>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                                <div id="preview_content" class="ck-content">
                                                                    ...
                                                                    @else
                                                                        <p>{{ __('admin/privacypolicy/privacypolicy.content_preview') }}
                                                                        </p>
                                                                    @endif
                                                                    <!--Post content-->
                                                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            <button class="btn btn-primary mb-3"
                                                type="submit">{{ $privacy_policy ? __('admin/common.update') : __('admin/common.create_new') }}</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
