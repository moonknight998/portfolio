<div class="sidebar sidebar-dark sidebar-fixed border-end" id="sidebar">
    ...
    <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
        ...
        <li class="nav-item"><a class="nav-link" href="{{ route('dashboard') }}">
                <svg class="nav-icon">
                    <use xlink:href="{{ asset('backend/assets/vendors/@coreui/icons/svg/free.svg#cil-speedometer') }}">
                    </use>
                </svg>{{ __('admin/sidebar.dashboard') }}<span class="badge badge-sm bg-info ms-auto">NEW</span></a>
        </li>
        <!--End General Part-->
        ...
        <li class="nav-group {{ request()->is('*admin*') ? 'show' : '' }}">
            ...
            <ul class="nav-group-items compact">
                ...
                <li class="nav-item"><a class="nav-link {{ request()->is('*admin/about*') ? 'active' : '' }}"
                        href="{{ route('admin.about.index') }}"><span
                            class="nav-icon"></span>{{ __('admin/sidebar.about-section') }}</a></li>
                <li class="nav-group {{ request()->is('*admin/value_card*') || request()->is('*admin/value_title*') ? 'show' : '' }}"
                    aria-expanded="true"><a class="nav-link nav-group-toggle" href="#">
                        <svg class="nav-icon">
                            {{-- <use xlink:href="{{asset('backend/assets/vendors/@coreui/icons/svg/free.svg#cil-home')}}"></use> --}}
                ...
                <li class="nav-item"><a class="nav-link {{ request()->is('*admin/count*') ? 'active' : '' }}"
                        href="{{ route('admin.count.index') }}"><span
                            class="nav-icon"></span>{{ __('admin/sidebar.count') }}</a></li>
                <li class="nav-group {{ request()->is('*admin/feature_list*') || request()->is('*admin/feature_title*') || request()->is('*admin/feature_icon_title*') || request()->is('*admin/feature_tab_item*') || request()->is('*admin/feature_icon_item*') ? 'show' : '' }}"
                    aria-expanded="true"><a class="nav-link nav-group-toggle" href="#">
                        <svg class="nav-icon">
                            {{-- <use xlink:href="{{asset('backend/assets/vendors/@coreui/icons/svg/free.svg#cil-home')}}"></use> --}}
                ...
                <li class="nav-group {{ request()->is('*admin/client_title*') || request()->is('*admin/client_item*') ? 'show' : '' }}"
                    aria-expanded="true"><a class="nav-link nav-group-toggle" href="#">
                        <svg class="nav-icon">
                            {{-- <use xlink:href="{{asset('backend/assets/vendors/@coreui/icons/svg/free.svg#cil-home')}}"></use> --}}
                ...
                <li class="nav-group {{ request()->is('*admin/blog_title*') ? 'show' : '' }}" aria-expanded="true"><a
                ...
                <li class="nav-group {{ request()->is('*admin/contact_title*') || request()->is('*admin/contact_item*') ? 'show' : '' }}"
                    aria-expanded="true"><a class="nav-link nav-group-toggle" href="#">
                        <svg class="nav-icon">
                            {{-- <use xlink:href="{{asset('backend/assets/vendors/@coreui/icons/svg/free.svg#cil-home')}}"></use> --}}
                ...
                <li class="nav-item"><a
                        class="nav-link {{ request()->is('*admin/terms_of_service*') ? 'active' : '' }}"
        ...
        <li class="nav-group {{ request()->is('*blog*') ? 'show' : '' }}">
            ...
            <ul class="nav-group-items">
                <li class="nav-group {{ request()->is('*blog/blog_category*') || request()->is('*blog/blog_post*') ? 'show' : '' }}"
                    aria-expanded="true">
