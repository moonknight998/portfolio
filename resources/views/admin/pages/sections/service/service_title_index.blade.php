                    ...
                    <div class="card-group d-block d-md-flex row">
                        <div class="card col-md-7 p-2 mb-4">
                            <div class="card-header">
                                <h2>{{ __('admin/service/service.update_title') }}</h2>
                            </div>
                            <form method="POST"
                                action="{{ $service_title == null ? route('admin.service_title.store') : route('admin.service_title.update', $service_title->id) }}"
                                        ...
                                        <div class="tab-content rounded-bottom" id="content_tab">
                                            <div class="tab-pane p-3 active preview" role="tabpanel">
                                                ...
                                                <div class="form-group mb-3">
                                                    <label
                                                        class="form-label">{{ __('admin/feature/feature.section_name') }}</label>
                                                    <input class="form-control" id="section_name" name="section_name"
                                                        type="text"
                                                        placeholder="{{ __('admin/feature/feature.section_name_placeholder') }}"
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <textarea class="form-control" rows="5" id="title" name="title" type="text"
                                                        ...
                                                        onkeypress="detectEnterline(event, 'title'); loadDocument(event, 'preview_title')">{{ $service_title ? ($service_title->title === '' ? old('title') : $service_title->title) : '' }}</textarea>
                                                    @if ($errors->has('title'))
                                                        <div class="row mb-0">
                                                            <div class="invalid-feedback" style="display: inline;">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <select class="form-select" id="status" name="status">
                                                        <option
                                                            {{ $service_title ? ($service_title->status == 1 ? 'selected' : '') : 'selected' }}
                                                            value="1">{{ __('admin/common.display') }}</option>
                                                        <option
                                                            {{ $service_title ? ($service_title->status == 0 ? 'selected' : '') : '' }}
                                                    ...
                                                    <div class="container aos-init aos-animate" data-aos="fade-up">
                                                        <header class="section-header">
                                                            <h2 id="preview_section_name">
                                                                {{ $service_title ? $service_title->section_name : __('admin/feature/feature.section_name_placeholder') }}
                                                            </h2>
                                                            <p id="preview_title">
                                                                {{ $service_title ? $service_title->title : __('admin/feature/feature.title_placeholder') }}
                                                            </p>
                                                        </header>
                                                            ...
                                                            @else
                                                                <div class="col-lg-4 col-md-6 aos-init aos-animate"
                                                                    ...
                                                                    <div class="service-box"
                                                                        style="border-bottom-style: solid;  border-bottom-width: 3px; border-bottom-color: #2db6fa;">
                                                                        <i class="ri-discuss-line icon-backend"
                                                                            style="color: #2db6fa; background: #dbf3fe"></i>
                                                                        <h3>{{ __('admin/common.title_preview') }}</h3>
                                                                        <p>{!! __('admin/common.description_preview') !!}</p>
                                                                        <a href="#"
                                                                            class="read-more"><span>{{ __('admin/common.read_more') }}</span>
